...
(function() {
  var Clipboard, MAX_LOG_SIZE, OriginalXMLHttpRequest, PREVIOUS_PATH, REPLAY_LOG, WrappedXMLHttpRequest, clearLog, clickListener, clipboard, controlsDiv, generateSelector, initialize, isStarted, listen, log, logClickHandler, loggedOnError, loggedOnPopState, originalOnError, originalOnPopState, replayCount, start, stop,
    slice = [].slice;
