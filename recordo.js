...
(function() {
  var Clipboard, MAX_LOG_SIZE, OriginalXMLHttpRequest, PREVIOUS_PATH, REPLAY_LOG, WrappedXMLHttpRequest, clearLog, clickListener, clipboard, controlsDiv, generateSelector, initialize, isStarted, listen, log, logClickHandler, loggedOnError, loggedOnPopState, originalOnError, originalOnPopState, replayCount, setStorage, start, stop,
    slice = [].slice;
  ...
  start = function(config) {
    ...
    window.addEventListener('beforeunload', function() {
      ...
      log('HISTORY', 'UNLOAD');
      return setStorage('__REPLAY_LOG', JSON.stringify(REPLAY_LOG));
    });
    isStarted = true;
    return setStorage('__REPLAY_AUTO_START', true);
  };
